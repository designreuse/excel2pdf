    ...
    try {
      ...
      if (byteArrayPdf != null) {
        File saveFileFromByteArray =
            ProcessUtils.saveFileFromByteArray(FileUtils.saveFile(this, "generated", ".pdf", "pdf"), byteArrayPdf);
        if (saveFileFromByteArray != null) {
          MessagesUtils.showInfo(this, "Soubor " + saveFileFromByteArray.getName() + " uložen");
        }
      }
